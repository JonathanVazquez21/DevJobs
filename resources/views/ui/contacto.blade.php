<aside class="md:w-2/5 bg-green-500 p-5 rounded m-3">
    ...
    <form action="{{route('candidatos.store')}}" enctype="multipart/form-data" method="POST">
        ...
        <div class="mb-4">
            ...
            <input id="nombre" type="text" class="p-3 bg-gray-100 rounded form-input w-full @error ('nombre') border border-red-500 @enderror"
        ...
        <div class="mb-4">
            ...
            <input id="email" type="text" class="p-3 bg-gray-100 rounded form-input w-full @error ('email') border border-red-500 @enderror"
        ...
        <div class="mb-4">
            ...
            <input id="cv" type="file" class="p-3 rounded form-input w-full @error ('cv') border border-red-500 @enderror"
