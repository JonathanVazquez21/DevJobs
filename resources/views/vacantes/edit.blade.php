...
@section('content')
    ...
    <form class="max-w-lg mx-auto my-10" action="{{route('vacantes.update', ['vacante' => $vacante->id])}}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input id="titulo" type="text" class="p-3 bg-gray-100 rounded form-input w-full  @error('titulo') is-invalid @enderror" name="titulo"  autocomplete="current-password" placeholder="Titulo de la Vacante" value="{{$vacante->titulo}}">
            @error('titulo')
